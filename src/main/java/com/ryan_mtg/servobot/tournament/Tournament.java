...
public class Tournament {
    ...
    private static final Set<Player> CARE_ABOUTS = new HashSet<>(Arrays.asList(
        ...
        new Player("Logan_Nettles#78747", null, "Logan Nettles", null, "jaberwocki", "Jaberwocki"),
        ...
        new Player("Aaron_Barich#54175", null, "Aaron_Barich", "Aaron_Barich", "RuneclawBarich", "RuneclawBarich"),
        ...
        new Player("Jack_Kiefer#39736", null, "Jack Kiefer", null, null, "JackBKiefer"),
        ...
        new Player("Lucas_EsperBerthoud#73368", null, "Lucas Esper Berthoud", "Lucas Esper Berthoud",
               "lucas_esper_berthoud", "bertuuuu"),
