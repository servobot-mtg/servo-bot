...
CREATE TABLE IF NOT EXISTS game_queue (id INTEGER AUTO_INCREMENT PRIMARY KEY, bot_home_id INTEGER, flags INTEGER,
                    game INTEGER, code VARCHAR(30), server VARCHAR(30), proximity_server VARCHAR(50),
                    gamer_tag_variable VARCHAR(30), state INTEGER, message_id BIGINT, channel_id BIGINT,
                    start_time BIGINT);
